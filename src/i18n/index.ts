...
import viBankAccount from './locales/vi/bankAccount'
import viBrand from './locales/vi/brand'
...
import enBankAccount from './locales/en/bankAccount'
import enBrand from './locales/en/brand'
