export default {
    order: {
        ...
        /* ================= Notifications ================= */
        /* ================= Work shift (`02-pos-mo-ca.png`) — PLAN Phase 15 ================= */
        shift: {
            open: {
                title: 'Open sales shift',
                subtitle: 'Enter the opening cash amount to start',
                branch: 'Sales branch',
                branchHint: 'Shifts and stock are tracked per branch.',
                openingCash: 'Opening cash (VND)',
                openingCashPlaceholder: 'e.g. 2000000',
                note: 'Note',
                notePlaceholder: 'Add a note if needed',
                submit: 'Open shift',
            },
            bar: {
                open: 'Shift {{code}} open',
                openedAt: 'Opened at {{time}}',
                openingCash: 'Opening {{amount}}',
                closeShift: 'Close shift',
            },
            close: {
                title: 'Close shift & count cash',
                subtitle: 'Count the actual cash in the drawer and enter it below.',
                closingCash: 'Counted cash (VND)',
                closingCashPlaceholder: 'e.g. 2350000',
                closingCashHint: 'Enter the counted amount; the system reconciles it against the expected amount.',
                note: 'Note',
                notePlaceholder: 'e.g. difference from giving change',
                submit: 'Close shift',
                doneTitle: 'Shift closed',
                doneSubtitle: 'Cash count result for shift {{code}}',
                balanced: 'Cash matches the expected amount.',
                short: 'Short by {{amount}} against the expected amount.',
                over: 'Over by {{amount}} against the expected amount.',
                finish: 'Done',
            },
            pending: {
                title: 'Shift awaiting approval',
                subtitle:
                    'Your shift request was sent. You can start selling once a manager approves it.',
                refresh: 'Check again',
            },
            list: {
                pageTitle: 'Work shifts',
                pageDescription: 'Approve shift requests and review cash counts',
                searchPlaceholder: 'Search by shift code or staff name…',
                allStatuses: 'All statuses',
                allBranches: 'All branches',
                resultLabel: 'shifts',
                empty: 'No work shifts yet',
                approve: 'Approve',
                reject: 'Reject',
                closeForStaff: 'Close for staff',
                column: {
                    code: 'SHIFT CODE',
                    staff: 'STAFF',
                    branch: 'BRANCH',
            ...
            detail: {
                orders: 'Orders in shift ({{count}})',
                noOrders: 'No orders in this shift yet.',
                ordersTruncated: 'Showing {{shown}} of {{total}} orders in this shift.',
            },
            reject: {
                title: 'Reject shift request',
                subtitle: '{{code}} · {{staff}} · opening cash {{amount}}',
                reason: 'Rejection reason',
                reasonPlaceholder: 'e.g. opening cash does not match the handover',
                hint: 'A rejected shift cannot be approved later; the staff must request a new shift.',
                submit: 'Reject shift',
            },
            closeForStaff: {
                title: 'Close shift for staff',
                subtitle: '{{code}} · {{staff}}',
            },
            field: {
                code: 'Shift code',
            ...
            toast: {
                requested: 'Shift request sent — waiting for approval',
