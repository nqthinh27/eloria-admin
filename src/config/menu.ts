...
export const mainMenu: MenuGroupType[] = [
    ...
    },
    {
        ...
        items: [
            // `/staff`, `/branch`, `/audit-log` là `[ADMIN]`, nên STAFF không thấy các mục này.
            { titleKey: 'menu.staff', url: '/staff', icon: UserRound, minRole: ERole.ADMIN },
            { titleKey: 'menu.branch', url: '/branch', icon: Building2, minRole: ERole.ADMIN },
            {
